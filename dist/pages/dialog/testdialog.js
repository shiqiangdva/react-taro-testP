...
var TestDialog = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(TestDialog, [{
    ...
    value: function _createData() {
      ...
      _index.propsManager.set({}, $compid__30);
  ...
  return TestDialog;
}(_index.Component), _class.$$events = [], _class.$$componentPath = "pages/dialog/testdialog", _temp2);
exports.default = TestDialog;

Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(TestDialog, true));