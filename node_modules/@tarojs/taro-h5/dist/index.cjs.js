...
var canvasGetImageData = function canvasGetImageData(_ref, componentInstance) {
  ...
  var canvas = component.vnode.dom.querySelector("[canvasId=".concat(canvasId, "]"));
  ...
  _createClass(ImageContainer, [{
    ...
    value: function render() {
      ...
      var defaultStyle = {
        left: divLeft,
        width: screenWidth,
        height: screenHeight // console.info('ImageContainer render');
...
function () {
  ...
  _createClass(Toast, [{
    ...
    value: function create() {
      ...
      var config = _objectSpread({}, this.options, options); // wrapper
      ...
      if (config.image) {
        this.icon.setAttribute('style', inlineStyle(_objectSpread({}, imageStyle, {
          'background-image': "url(".concat(config.image, ")")
        })));
      } else {
        var iconStyle = config.icon === 'loading' ? loadingStyle : successStyle;
        this.icon.setAttribute('style', inlineStyle(_objectSpread({}, iconStyle, config.icon === 'none' ? {
          'display': 'none'
        } : {})));
      ...
      this.toast.setAttribute('style', inlineStyle(_objectSpread({}, toastStyle, config.icon === 'none' ? {
        'min-height': '0',
        'padding': '10px 15px'
      } : {}))); // title
    ...
    value: function show() {
      ...
      var config = _objectSpread({}, this.options, options);
...
function () {
  ...
  _createClass(Modal, [{
    ...
    value: function create() {
      ...
      var titleCSS = config.title ? titleStyle : _objectSpread({}, titleStyle, {
        display: 'none'
      });
      ...
      var textCSS = config.title ? textStyle : _objectSpread({}, textStyle, {
      ...
      var cancelCSS = _objectSpread({}, btnStyle, {
    ...
    value: function show() {
      ...
      if (config.title) {
        ...
        var textCSS = _objectSpread({}, textStyle, {
          padding: '40px 20px 26px',
          color: '#353535'
        });
...
function () {
  ...
  _createClass(ActionSheet, [{
    ...
    value: function create() {
      ...
      this.menu.setAttribute('style', inlineStyle(_objectSpread({}, menuStyle, {
